      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="text-center flex flex-col items-center">
            ...
            <div className="flex gap-6 mt-4 sm:mt-0">
              <a
                href="#"
                className="text-gray-400 hover:text-blue-400 hover:scale-125 transition-all duration-300 hover:shadow-lg-premium rounded-full p-2"
              >
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-400 gap-6">
          ...
          <div className="flex gap-8">
            <FontAwesomeIcon
              icon={faPaypal}
              className="w-10 h-10 hover:text-blue-400 transition-all duration-300 hover:scale-110"
            />
          </div>
        </div>
      </div>

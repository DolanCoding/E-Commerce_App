          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {password && (
                <div className="mt-2 flex gap-1">
                  <div
                    className={`h-1 flex-1 rounded-full ${passwordStrength === "strong" ? "bg-green-500" : passwordStrength === "medium" ? "bg-yellow-500" : "bg-red-500"}`}
                  ></div>
                  <div
                    className={`h-1 flex-1 rounded-full ${passwordStrength === "strong" ? "bg-green-500" : "bg-gray-200"}`}
                  ></div>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {confirmPassword && password === confirmPassword && (
                <p className="mt-2 text-green-600 text-sm font-semibold flex items-center gap-2">
